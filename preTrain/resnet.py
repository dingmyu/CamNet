...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000):
        ...
        self.layer4_ICR = self._make_layer4(block, 512, layers[3], stride=2)
        self.layer4_PFR = self._make_layer4(block, 512, layers[3], stride=2)
        self.layer4_PRP = self._make_layer4(block, 512, layers[3], stride=2)
    ...
    def _make_layer4(self, block, planes, blocks, stride=1):
        downsample = None
        if stride != 1 or self.inplanes != planes * block.expansion:
            downsample = nn.Sequential(
                nn.Conv2d(self.inplanes, planes * block.expansion,
